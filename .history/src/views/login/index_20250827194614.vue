    ...
    <div class="loginbox">
      ...
      <div class="rights" v-if="!isRegistry">
        ...
        <div class="login-header-group">
          ...
          <p class="login-desc">欢迎使用闪聚支付系统</p>
        </div>
          ...
          >
            <div class="input-wrapper">
              ...
              >
                <template #suffix>
                  <span 
                    @click="addPassFlag = !addPassFlag" 
                    class="input-action-icon"
                    :title="addPassFlag ? '隐藏密码' : '显示密码'"
                  >
                    <el-icon v-if="addPassFlag"><i class="el-icon-eye"></i></el-icon>
                    <el-icon v-else><i class="el-icon-eye-close"></i></el-icon>
                  </span>
                </template>
              </el-input>
            </div>
          ...
          >
            <div class="input-wrapper">
              ...
              <el-icon
                class="view"
                @click="showPwd"
                :class="passwordType === 'password' ? '' : 'hide'"
                :title="passwordType === 'password' ? '显示密码' : '隐藏密码'"
              ></el-icon>
            </div>
            <!-- 密码强度提示 -->
            <div class="pwd-strength" v-if="registryForm.password">w
...
import { Eye, EyeClose } from '@element-plus/icons-vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const addPassFlag= ref('password')
