        ...
        >
          ...
          >
            <div class="input-wrapper">
              ...
              <!-- 密码可见切换：带hover提示 -->
              <i 
                class="el-icon-eye input-action-icon" 
                @click="showPwd"
                :class="passwordType === 'password' ? '' : 'el-icon-eye-close'"
        ...
        >
          ...
          >
            <div class="input-wrapper">
              ...
              />
              <i 
                class="el-icon-view <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024"><path fill="currentColor" d="M512 160c320 0 512 352 512 352S832 864 512 864 0 512 0 512s192-35" 
                @click="showPwd"
